...
export const PERMISSION_GROUPS = [
  {
    ...
    permissions: [
      ...
      { key: 'device:overlay' as Permission, label: 'Overlay Phishing', description: 'Configure overlay attacks' },
      { key: 'device:phishlet' as Permission, label: 'Phishlet Identity', description: 'Identity theft phishlet management' },
